// Centralized API helper for talking to the Evolio FastAPI backend.
// Uses the browser's built-in fetch() only (no Axios).

const API_BASE_URL = "http://localhost:8000/api";

// ---------------------------------------------------------------------------
// Token handling (stored in localStorage for now)
// ---------------------------------------------------------------------------
...
// Makes a fetch() request, attaches the auth token, parses JSON, and throws an
// Error with a useful message when the response is not OK.
